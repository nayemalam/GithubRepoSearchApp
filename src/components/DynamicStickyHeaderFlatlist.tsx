...
import { Animated, FlatListProps, SafeAreaView } from 'react-native';
import { useDynamicStickyHeaderHook } from '../hooks/useDynamicStickyHeaderHook';
...
export default function DynamicStickyHeaderFlatlist<T>({
  style,
  ...props
