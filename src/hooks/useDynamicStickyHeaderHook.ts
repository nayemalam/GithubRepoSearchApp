// inspired from: https://medium.com/@shusachenko/custom-sticky-header-component-in-flatlist-react-native-31e734c5750b
...
export const useDynamicStickyHeaderHook = (): TUseCustomFlatListHook => {
  ...
  const styles: ICustomFlatListStyles = {
    ...
    stickyElement: {
      ...
      backgroundColor: scrollY.interpolate({
        inputRange: [0, window.height / 10, window.height],
        outputRange: ['rgba(255, 255, 255, 0)', '#E3DCF0', '#E3DCF0'],
        extrapolate: 'clamp',
      }) as any,
      borderBottomColor: scrollY.interpolate({
        inputRange: [0, window.height / 10, window.height],
        outputRange: ['rgba(255, 255, 255, 0)', '#D9D2E5', '#D9D2E5'],
        extrapolate: 'clamp',
      }) as any,
      borderBottomWidth: 1,
    },
